...
export const KAVRAMLAR = [
  ...
  { ad: "Toplam / Aktif (MoE)", benzet: "Koca hastane ama seni tek uzman muayene eder.", ozet: "MoE modelde tüm parametreler bellekte durur, ama her token için yalnızca küçük bir kısmı (aktif) çalışır. Belleği büyük modele göre, hızı küçük modele göre planla." },
  ...
  { ad: "Bağlam uzunluğu", benzet: "Masaya aynı anda sığdırabildiğin kağıt sayısı.", ozet: "Modelin bir anda aklında tutabildiği metin miktarı. Uzun bağlam daha çok KV cache, yani daha çok bellek demek." },
  ...
  { ad: "İlk token gecikmesi", benzet: "Garsonun siparişi alıp mutfağa iletmesi.", ozet: "Soruyu gönderdikten sonra cevabın ilk harfi gelene kadar geçen 'düşünme' süresi. Uzun istemde ve kalabalıkta uzar." },
...
export const SENARYOLAR = [
  ...
  },
  {
    ...
    aciklama: "Ajan işleri uzun istem ve uzun bağlam ister; ilk token toleransı yüksektir.",
